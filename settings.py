...
EVENT_TEMPLATE['HTML_SUBTITLE'] = "<h4>{subtitle}\n</h4>"
EVENT_TEMPLATE['TEXT_SUBTITLE'] = "<h4>{subtitle}\n</h4>"
...
EVENT_HTML_TEMPLATE_CUSTOM_SUB = (EVENT_TEMPLATE['HTML_TITLE'] + EVENT_TEMPLATE['HTML_SUBTITLE'] \
        + EVENT_TEMPLATE['HTML_DESC'])

EVENT_TEXT_TEMPLATE_CUSTOM_SUB = (EVENT_TEMPLATE['TEXT_TITLE'] + EVENT_TEMPLATE['TEXT_SUBTITLE'] \
