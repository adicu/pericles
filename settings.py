...
EVENT_HTML_TEMPLATE_NO_TIMES = (EVENT_TEMPLATE['HTML_TITLE'] + EVENT_TEMPLATE['HTML_START_DATE'] \
        + " &mdash; " + EVENT_TEMPLATE['END_DATE'] + EVENT_TEMPLATE['HTML_LOC'] \
        + EVENT_TEMPLATE['HTML_DESC']) 
...
EVENT_TEXT_TEMPLATE_NO_TIMES = (EVENT_TEMPLATE['TEXT_TITLE'] + EVENT_TEMPLATE['TEXT_START_DATE'] \
        + " &mdash; " + EVENT_TEMPLATE['END_DATE'] + EVENT_TEMPLATE['TEXT_LOC'] \
        + EVENT_TEMPLATE['TEXT_DESC']) 
